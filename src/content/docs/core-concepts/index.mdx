...
### The VibeCoded Marker

In v0.2, we use `raise VibeCoded()` to mark where AI should generate code. This
pattern:
- **Semantically clear**: "This function is AI-coded"
- **Type-safe**: Properly signals to type checkers
- **Explicit**: Clearly marks the AI boundary in your code

```python
@vibesafe
def process(data: str) -> dict:
    """Parse and process data."""
    # Pre-processing can go here
    validated = validate_input(data)

    # Mark the AI boundary
    raise VibeCoded()  # AI generates implementation from here
```
...
Everything before the raise is preserved. Hash includes it.
